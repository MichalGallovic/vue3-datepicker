...
const render$5 = /*#__PURE__*/_withId$1((_ctx, _cache, $props, $setup, $data, $options) => {
  return (vue.openBlock(), vue.createBlock("div", {
    ...
    vue.createVNode("div", null, [
      vue.renderSlot(_ctx.$slots, "picker-popup-header")
    ]),
...
function render$2(_ctx, _cache, $props, $setup, $data, $options) {
  ...
  return (vue.openBlock(), vue.createBlock(_component_picker_popup, {
    ...
    "picker-popup-header": vue.withCtx(() => [
      vue.renderSlot(_ctx.$slots, "day-picker-header")
    ]),
    _: 1 /* STABLE */
  }, 8 /* PROPS */, ["leftDisabled", "rightDisabled", "items", "onLeft", "onRight"]))
}
...
function render(_ctx, _cache, $props, $setup, $data, $options) {
  ...
  return (vue.openBlock(), vue.createBlock("div", {
    ...
    vue.withDirectives(vue.createVNode(_component_day_picker, {
      ...
      "day-picker-header": vue.withCtx(() => [
        vue.renderSlot(_ctx.$slots, "header")
      ]),
      _: 1 /* STABLE */
    }, 8 /* PROPS */, ["pageDate", "selected", "weekStartsOn", "lowerLimit", "upperLimit", "disabledDates", "locale", "weekdayFormat", "onSelect"]), [
